...
/datum/techweb_node/nanite_smart
	...
	research_costs = list(TECHWEB_POINT_TYPE_NANITES = 500)
...
/datum/techweb_node/nanite_neural
	...
	research_costs = list(TECHWEB_POINT_TYPE_NANITES = 1000)
...
/datum/techweb_node/nanite_harmonic
	...
	research_costs = list(TECHWEB_POINT_TYPE_NANITES = 3000)
...
/datum/techweb_node/nanite_hazard
	...
	research_costs = list(TECHWEB_POINT_TYPE_NANITES = 4000)
