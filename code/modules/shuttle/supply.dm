GLOBAL_LIST_INIT(blacklisted_cargo_types, typecacheof(list(
		...
		/obj/item/mail, // KF: Prohibit sale of mail.
...
/obj/docking_port/mobile/supply
	name = "supply shuttle"
	id = "supply"
	callTime = 100 // KF: Reduce massive call time from 60 to 10 seconds.
...
/obj/docking_port/mobile/supply/proc/buy()
	...
	// KF: Track total imports for mail purposes.
...
/obj/docking_port/mobile/supply/proc/sell()
	...
	// KF: Track total exports for mail purposes.
...
/// KF: Generates a box of mail depending on our exports and imports.
